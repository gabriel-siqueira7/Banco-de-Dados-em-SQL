/*
Atividade proposta módulo 11
*/

create database restaurante;
use restaurante;

alter table funcionarios rename column daya_nascimento to data_nascimento;
alter table funcionarios drop column daya_nascimento;
alter table funcionarios add column nome varchar(255);   -- exclusão de coluna errada na tabela. Exclui uma coluna errada, editei o nome da coluna e adicionei a coluna retirada por engano
...
delete from funcionarios where id_funcionario = 1; -- Id_funcionario começa no "2" na tabela porque foi excluido o registro repetido do mesmo funcionário

update funcionarios -- trocado o cargo para garçonete e salario aumentou para R$ 2700,00
set cargo = 'Garçonete', salario = 2700.00
where id_funcionario = '5';

delete from funcionarios where id_funcionario = 3; -- excluido dado do funcionario de cpf  222.333.444-55 - Lívia Castro

insert into funcionarios (nome, CPF, data_nascimento, endereco, telefone, email, cargo, salario, data_admissao) values -- adicionado dados de novos funcionários
...
insert into clientes (nome, cpf, data_nascimento, endereco, telefone, email, data_cadastro) values -- adicionado dados de clientes
...
insert into produtos (nome, descricao, preco, categoria) values -- adicionado dados dos produtos
...
set sql_safe_updates = 1; -- desativar modo safe para rodar a edição de pedidos
create table pedidos_backup as select * from pedidos; -- backup antes das alterações

update pedidos
set status_pedido = 'Concluído'
where data_pedido <= '2024-07-06';  -- atualizado os pedidos menores que 2024-07-06 para concluídos

insert into pedidos (id_cliente, id_funcionario, id_produto, quantidade, data_pedido, status_pedido) values -- adicionado os dados dos pedidos
...
insert into info_produtos (id_produto, ingredientes, fornecedor) values -- adicionado dados dos info_produtos
